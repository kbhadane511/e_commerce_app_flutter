...
class CTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.white),
